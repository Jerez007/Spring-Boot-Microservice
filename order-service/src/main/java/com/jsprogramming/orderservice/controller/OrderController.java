...
public class OrderController {
    ...
    public CompletableFuture<String> placeOrder(@RequestBody OrderRequest orderedRequest) {
        return CompletableFuture.supplyAsync(() ->orderService.placeOrder(orderedRequest));
    }
